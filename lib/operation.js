...
function rotate (angle, options) {
  ...
  if (!is.defined(angle) && this.options.input.useInitialOrientation === true) {
    this.options.debuglog('Use Initial Rotation Mode ignores empty calls to `rotate()`');
  } else if (!is.defined(angle)) {
